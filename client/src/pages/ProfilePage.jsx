      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12 space-y-10 animate-fadeIn">
            ...
            <div className="flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                  ...
                  {stats?.racesWon > 0 && (
                    <span className="px-4 py-1.5 bg-purple-500/10 border border-purple-500/30 rounded-full text-purple-400 text-sm font-semibold">
                      🏆 Champion
                    </span>
                  )}
                </div>
        ...
        {userRank && (
          <div className="relative">
            ...
            <div className="relative bg-neutral-900 border border-neutral-800 rounded-2xl p-8 shadow-xl">
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  <div className="text-neutral-500 text-sm">Top</div>
